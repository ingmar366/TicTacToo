...
var _playerView = require("./views/playerView");
var _playerViewDefault = parcelHelpers.interopDefault(_playerView);
...
const modalClick = function(e) {
    ...
    if (targetClasses === "start__button") {
        ...
        (0, _modalViewDefault.default).hideStart();
    }
    // reseting and clearing everything when start button has been clicked
    if (targetClasses === "restart__button") {
        (0, _gameViewDefault.default).clearMarkers();
        (0, _modalViewDefault.default).toggleModal();
        (0, _modalViewDefault.default).hideRestart();
        (0, _modalViewDefault.default).hideTie();
        _model.reset();
        (0, _playerViewDefault.default).resetStartPlayer();
    }
};
////////////////////////////////////////////////////////////
//                                                        //
...
const tieHandler = function() {
    (0, _modalViewDefault.default).toggleModal();
    (0, _modalViewDefault.default).showTie();
};
////////////////////////////////////////////////////////////
//                                                        //
//                        WINNING                         //
...
const updateFilledLocation = function(player) {
    const content1 = (0, _gameViewDefault.default).getAllCellContent();
    // array with all filled locations of the current player
    let filledArr;
    // places the marker
    if (player === 1) filledArr = filledCells(content1, "circle");
    if (player === 2) filledArr = filledCells(content1, "cross");
    // update the array of the current player
    _model.updatePlayerArray(`player${player}`, filledArr);
...
const filledCells = function(cells, symbol) {
    ...
    content = Object.entries(cells).reduce((acc, item)=>{
        if (window.getComputedStyle(item[1], false).backgroundImage.includes(symbol)) acc.push(parseInt(item[1].dataset.set));
        return acc;
    }, []);
    return content;
};
...
const checkPlayerWon = function(player) {
    const winningData = _model.winningArray;
    // comparing the current array of the player with the options for winning
    const info = winningData.filter((item)=>item.every((v)=>_model.state[`player${player}`].includes(v)));
    // checking if one of the values return true, in this case it will trigger the modal
    if (info.length > 0) {
        (0, _modalViewDefault.default).toggleModal();
        (0, _modalViewDefault.default).showRestart(`player ${player}`);
...
const placeMarker = function(e) {
    ...
    const currentActivePlayer = _model.state.activePlayer;
    //   check for clicks outside of the cells
    if (clickLocation.classList.contains("game")) return;
    //   check if location is emtpy
    if (window.getComputedStyle(clickLocation, false).backgroundImage !== "none") return;
    // based on player depends on which background is selected
    if (_model.state.activePlayer === 1) {
        (0, _gameViewDefault.default).setBackground(clickLocation, "circle.deebfa26.svg");
        // switching to other player
        _model.updateActivePlayer(2);
    } else {
        (0, _gameViewDefault.default).setBackground(clickLocation, "cross.64d8e85c.svg");
        // switching to other player
        _model.updateActivePlayer(1);
    }
    ...
    (0, _playerViewDefault.default).updateActivePlayer();
    // after placing a marker reduce the empty fields
    _model.withDrawlEmptyField();
    // checking if there are still empty fields available
    if (_model.state.emptyFields === 0 && winning === 0) tieHandler();
};
////////////////////////////////////////////////////////////
//                                                        //
//                        init                            //
...
const init = function() {
    (0, _modalViewDefault.default).clickHandler(modalClick);
    (0, _gameViewDefault.default).cellClickHanlder(placeMarker);
};
init();

},{"./model":"Y4A21","./views/gameView":"2oHQ0","./views/playerView":"e6ext","./views/modalView":"8QpnA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "winningArray", ()=>winningArray);
parcelHelpers.export(exports, "updateActivePlayer", ()=>updateActivePlayer);
parcelHelpers.export(exports, "withDrawlEmptyField", ()=>withDrawlEmptyField);
parcelHelpers.export(exports, "updatePlayerArray", ()=>updatePlayerArray);
...
const updateActivePlayer = function(updatedValue) {
    state.activePlayer = updatedValue;
};
const withDrawlEmptyField = function() {
    state.emptyFields -= 1;
};
const updatePlayerArray = function(player, arr) {
    state[player] = arr;
};
...
},{}],"2oHQ0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class GameView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e6ext":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class PlayerView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire9309")
